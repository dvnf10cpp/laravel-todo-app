...
<html lang="en" data-bs-theme="dark">
  ...
  <body>
    ...
    <section>
      <form class="container mt-5" action="{{ route('todos.store') }}" method="POST">
        @csrf
        <div class="mb-3">
        ...
        <div class="mb-3">
          ...
          <input type="date" class="form-control" id="tanggal-input" aria-describedby="emailHelp" style="width:20%;" name="tanggal">
          @error('tanggal')
          <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
          @enderror
        </div>
